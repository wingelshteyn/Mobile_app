## Android-проект (практические 2, 3 и 4)

Проект на **Kotlin + Jetpack Compose**: мобильный UI с боковым меню (вкладки).

### Практика 4 — карта и внешний API
- **Карта:** OpenStreetMap (osmdroid), метки с описанием — вкладка **Карта** (`MapScreen`, `OsmMapView`, `MapMarkers`)
- **API:** [Open-Meteo](https://open-meteo.com/) — вкладка **Погода** (`WeatherRepository`, `WeatherViewModel`)
- Руководство и сборка APK: см. папку **`../../pr_4/`** (`USER_GUIDE.md`, `BUILD_APK.md`)

### Практика 2 — интерфейс
- Вкладки: **Чаты / Заметки / Погода / Карта / Настройки**
- Topbar, «стеклянные» карточки, тёмная тема, анимированный фон
- Чаты и настройки — **статические данные** (`StaticData.kt`); погода и карта — **pr_4** (API + OSM)
